...
public class ForwardServer
{
    ...
    //this is for the server to decrypt and encrypt session messages
    ...
    private void doHandshake() throws Exception {
        ...
        Handshake.verifyhello(clientSocket,arguments.get("cacert"),"ClientHello");
        Handshake.hello(clientSocket,arguments.get("usercert"),"ServerHello");
        Handshake.acceptforward(clientSocket);
        /*
         ...
         */
        listenSocket = new ServerSocket(0,2,InetAddress.getLocalHost());
        Handshake.session(clientSocket,InetAddress.getLocalHost().getHostAddress(),Integer.toString(listenSocket.getLocalPort()));
        this.sessionEncrypter = Handshake.getSessionEncrypter();
        this.sessionDecrypter = Handshake.getSessionDecrypter();
        clientSocket.close();
            ...
            throws Exception
    {
        ...
        while(true) {
            ...
            try {
                ...
                forwardThread = new ForwardServerClientThread(this.listenSocket, this.targetHost, this.targetPort,this.sessionEncrypter,this.sessionDecrypter);
                forwardThread.start();
            } catch (IOException e) {
                throw e;
            }
