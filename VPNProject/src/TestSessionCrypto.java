...
public class TestSessionCrypto {
    ...
    static String PLAININPUT = "plaininput.txt";
    static String PLAINOUTPUT = "plainoutput.txt";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(new File(PLAININPUT).getAbsolutePath());
        ...
        // Now ciphertext is in cipher output file. Decrypt it back to plaintext.// Create decrypter instance using cipher parameters from encrypter
