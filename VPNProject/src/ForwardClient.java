...
public class ForwardClient
{
    ...
    //this is for the client to decrypt and encrypt session messages
    ...
    private static void doHandshake() throws Exception {
        ...
        Handshake.hello(socket,arguments.get("usercert"),"ClientHello");
        Handshake.verifyhello(socket,arguments.get("cacert"),"ServerHello");
        Handshake.forward(socket,arguments.get("targethost"),arguments.get("targetport"));
        Handshake.acceptsession(socket,arguments.get("key"));
    ...
    static public void startForwardClient() throws Exception {
        ...
        try {
            ...
            //the forwardserverclientthread needs the created encrypt/decrypt so we send them here
